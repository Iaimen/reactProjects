                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="img-box">
                                    <img src="/assets/images/saving-img.png" alt="Saving Offer" />
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="detail-box">
                                    ...
                                    <p>
                                        ...
                                        eveniet blanditiis praesentium totam non nostrum dignissimos nihil eius facere et eaque. Qui,
                                        animi obcaecati.
                                    </p>
                                    <div className="btn-box">
                                        <button className="btn1" onClick={() => navigate('/shop')} style={{ 'padding': '15px', 'borderRadius': '5%' }}>
                                            Buy Now
                                        </button>
                ...
                <div className="container">
                 ...
                 C281.901,181.576,281.901,176.501,278.771,173.37z" />
                        ...
                        <div className="col-md-4">
                            <div className="box ">
                                <div className="img-box">
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" style={{ enableBackground: "new 0 0 490.667 490.667;" }} >
                                        <g>
                                            <g>
